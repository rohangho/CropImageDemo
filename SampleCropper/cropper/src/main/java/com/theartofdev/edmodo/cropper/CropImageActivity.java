...
public class CropImageActivity extends AppCompatActivity
  ...
  private Button uplkaodImageSuccessful;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    uplkaodImageSuccessful=findViewById(R.id.submit);
    uplkaodImageSuccessful.setOnClickListener(new View.OnClickListener() {
      @Override
